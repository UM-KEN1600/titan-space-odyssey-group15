...
public class State2 {
    ...
    double xCoor = 1.368066213478404E9;
    double yCoor = -4.855873350071141E8;
    double zCoor = -4.64619118511653E7;
    ...
    {
        //Venus
        state[1][0][0] = 8.76566545731475E7;
        state[1][0][1] = -6.420935170509814E7;
        state[1][0][2] = -5903604.962601675;

        state[1][1][0] = 20.287334007167264;
        state[1][1][1] = 28.417414193076244;
        state[1][1][2] = -0.7895892030178082;

        //earth
        state[2][0][0] = -1.5027390887847453E8;
        state[2][0][1] = -266379.9957901824;
        state[2][0][2] = 30169.396011196517;

        state[2][1][0] = -0.34377112367512325;
        state[2][1][1] = -29.90637432177236;
        state[2][1][2] = 0.0026356871281662587;
       
        //Moon
        state[3][0][0] = -1.5018111837330297E8;
        state[3][0][1] = -625302.83194563;
        state[3][0][2] = -3984.3859983245916;

        state[3][1][0] = 0.6531204069000782;
        state[3][1][1] = -29.581658457972523;
        state[3][1][2] = 0.006116260412534776;

        //Mars
        state[4][0][0] = 1.3267604093839024E8;
        state[4][0][1] = -1.634680319363189E8;
        state[4][0][2] = -6682356.942974153;

        state[4][1][0] = 19.557663020223135;
        state[4][1][1] = 17.306109253264292;
        state[4][1][2] = -0.11762535723450541;

        //Jupiter
        state[5][0][0] = 4.426650504631947E8;
        state[5][0][1] = 6.017293856122143E8;
        state[5][0][2] = -1.2398034267897502E7;

        state[5][1][0] = -4.71443059866156;
        state[5][1][1] = 8.343568478544865;
        state[5][1][2] = 0.2045194441606508;

        //Saturn
        state[6][0][0] = 1.3673313709129553E9;
        state[6][0][1] = -4.86375563207802E8;
        state[6][0][2] = -4.5982105163602896E7;

        state[6][1][0] = 2.697635448775224;
        state[6][1][1] = 9.08310521318852;
        state[6][1][2] = -0.26495292873958554;

        //Titan

        state[7][0][0] = 1.3680660525855498E9;
        state[7][0][1] = -4.855874718467006E8;
        state[7][0][2] = -4.6461802329499E7;

        state[7][1][0] = -1.6483269592982837;
        state[7][1][1] = 12.530099563673652;
        state[7][1][2] = -1.609560201968816;
        ...
        //Mercury
        state[9][0][0] = -5.920227038905755E7;
        state[9][0][1] = -1.655211543855301E7;
        state[9][0][2] = 4131931.724750479;

        state[9][1][0] = 3.807371974509539;
        state[9][1][1] = -43.95269938788399;
        state[9][1][2] = -3.8651870947400564;

        //Neptune
        state[10][0][0] = 4.465320828891666E9;
        state[10][0][1] = -2.258947728677036E8;
        state[10][0][2] = -9.826093214817683E7;
        ...
        //Uranus
        state[11][0][0] = 1.7920578370959854E9; 
        state[11][0][1] = 2.3190705946772537E9;
        state[11][0][2] = 17235283.8321992;

        state[11][1][0] = -5.438652540862082;
        state[11][1][1] = 3.8462745422006375;
        state[11][1][2] = 0.07903879555693478;
