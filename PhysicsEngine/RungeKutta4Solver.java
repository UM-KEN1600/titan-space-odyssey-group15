...
public class RungeKutta4Solver implements iSolver {
    ...
    public double[][] solve(CelestialBody body, double timestep, double[][] oldState) 
    {
        ...
        k1[acceleration] = euler.accelerationCalculation(body.getMass(), State.getForce(body.rowInState));
        //VectorOperations.vectorScalarDivision(State.getForce(body.rowInState), body.getMass());
        //k1 * h
